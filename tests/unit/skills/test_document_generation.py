"""Unit tests for document generation skills (PPTX, DOCX, XLSX).

Tests the underlying libraries used for document generation.
These don't call the agent - they verify the library functionality.
"""
